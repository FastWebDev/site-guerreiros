  ...
  Formbuilder = (function() {
    ...
    Formbuilder.options = {
      ...
      dict: {
        ...
        SAVE_FORM: 'Save form',
        UNSAVED_CHANGES: 'You have unsaved changes. If you leave this page, you will lose those changes! So please wait a bit and try again'
      }
    };
...
(function() {
  Formbuilder.registerField('text', {
    ...
    edit: "<%= Formbuilder.templates['edit/size']() %><%= Formbuilder.templates['edit/initial']() %>",
...
(function() {
  Formbuilder.registerField('copy', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"fa fa-file-text-o\"></span></span> Text/Paragraph",
	defaultAttributes: function(attrs) {
...
(function() {
  Formbuilder.registerField('submit', {
    order: 12,
	type:'non_input',
    view: "<input class=\"submit-button\" value=\"<%= rf.get(Formbuilder.options.mappings.LABEL) %>\" type='button' />",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-check\"></span></span> Submit Button",
	defaultAttributes: function(attrs) {
	   attrs.required = false;
	   attrs.label = 'Submit';
...
(function() {
  Formbuilder.registerField('captcha', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-question\"></span></span> Captcha"
  });
...
'\n  </div>\n  <div class=\'fb-common-checkboxes\'>\n    ' +
((__t = ( Formbuilder.templates['edit/checkboxes_non_input']() )) == null ? '' : __t) +
'\n  </div>\n  <div class=\'fb-clear\'></div>\n</div>\n';
...
'\'\n  placeholder=\'Add Guideline for User\'></textarea>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="fb-edit-section-header">Copy/Text</div>\n<div class=\'fb-edit-editor\'><textarea data-rv-input=\'model.' +
((__t = ( Formbuilder.options.mappings.HTML )) == null ? '' : __t) +
'\'\n  placeholder=\'Add text/copy for this field\'></textarea></div>';
...
'\'\n  placeholder=\'Enter Value\' /><br />Any value. You can also integrate customer data. Available customer data are: {firstName}, {lastName}, {name}, {address}, {email}, {city}, {state}, {zip}, {company}</div>';
...
'\n<div class=\'fb-clear\'></div>\n<div class="fb-edit-section-header">Validation RegExp </div>\n<div class=\'fb-edit-regex\'><input data-rv-input=\'model.' +
((__t = ( Formbuilder.options.mappings.RGEX )) == null ? '' : __t) +
'\'\n class="regex" placeholder=\'Regular Expression\' /><br /> PHP regular expression. Check this <a target="_blank" href="http://opencartmart.com/xform-validation">URL</a> to see common validation pattern</div>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-right\'>\n  <div class=\'fb-no-response-fields\'><i class="fa fa-frown-o"></i> This form does not have any fields</div>\n  <div class=\'fb-response-fields\'></div>\n</div>\n';
