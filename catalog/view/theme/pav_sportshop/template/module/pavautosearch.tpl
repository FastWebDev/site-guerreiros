<div class="<?php echo $additional_class; ?>search_block clearfix">
	...
	<?php } ?>
	<div id="search<?php echo $module ?>" class="search-input-wrapper pull-left">
	    <input type="text" value="" size="35" autocomplete="off" placeholder="Pesquisar..." name="search" class="input-search form-control">
