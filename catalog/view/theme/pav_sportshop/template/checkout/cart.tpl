...
<div class="container">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($product['thumb']) { ?>
                  <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-rounded" /></a>
                  <?php } ?></td>
                ...
                <td class="quantity "><div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <button type="submit" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="btn btn-primary scriptrespon"><i class="fa fa-refresh"></i></button>
                    <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger scriptrespon" onclick="cart.remove('<?php echo $product['key']; ?>');"><i class="fa fa-times-circle"></i></button></span></div></td>
      ...
      <div class="buttons">
        <div class="pull-left"><a href="<?php echo $continue; ?>" class="button btn btn-outline-inverse"><?php echo $button_shopping; ?></a></div>
        <div class="pull-right"><a href="<?php echo $checkout; ?>" class="button btn btn-outline-inverse"><?php echo $button_checkout; ?></a></div>
      </div>
