...
<div class="container">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content" class="bg-content"><?php echo $content_top; ?>
      ...
      <div class="table-responsive">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><input type="button" value="<?php echo $button_cart; ?>" class="btn btn-default" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" />
