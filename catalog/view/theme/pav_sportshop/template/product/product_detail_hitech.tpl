        ...
        <div id="product" class="product-extra ">
            ...
            <div class="btn-group-justified">
                <div class="cart pull-left">
                    <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-outline-inverse"><span class="fa fa-shopping-cart"></span><?php echo $button_cart; ?></button>
                </div>
                <div class="action pull-left">
                    <div class="pull-left">
                        <a class="wishlist btn btn-outline"  data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><span class="fa fa-heart"></span><?php echo $button_wishlist; ?></a>
                    </div>
                    <div class="pull-left">
                        <a class="compare btn btn-outline" data-toggle="tooltip"  title="Promoções" href="" ><span class="fa fa-line-chart"></span>Promoções</a>
                    </div>
                </div>
...
<div class="tabs-group box">
 ...
 <?php foreach($tabs as $tab){?>
              <li><a href="#tab-tabs-<?php echo $tab['tab_id']?>" id="desc" data-toggle="tab"><?php echo $tab['name']; ?></a></li>
            <?php }?>
...
<?php foreach($tabs as $tab){?>
              <div class="tab-pane" id="tab-tabs-<?php echo $tab['tab_id'];?>">
              <?php echo html_entity_decode($tab['content'], ENT_QUOTES, 'UTF-8'); ?>
                </div>
              <?php }?>
        <?php if ($attribute_groups) { ?>
...
<script type="text/javascript">
   jQuery('#anc-luva').click(function anc(){
