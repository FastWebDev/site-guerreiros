...
//START EXTRA PRODUCT TABS
        ...
        $query = $this->db->query("SELECT tab_id, name, content FROM " . DB_PREFIX . "product_tabs WHERE product_id = '" . (int)$product_id . "' AND language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY sort_order ASC, name ASC");
        return $query->rows;
    	}
    	//START EXTRA PRODUCT TABS
