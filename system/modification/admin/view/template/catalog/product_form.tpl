        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-links" data-toggle="tab"><?php echo $tab_links; ?></a></li>
                ...
                <li><a href="#tab-tabs" data-toggle="tab"><?php echo $text_tabs; ?></a></li>
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                ...
                <div class="tab-pane active" id="tab-tabs">
                    <ul class="nav nav-tabs" id="tab-language">
                        <?php foreach ($languages as $language) { ?>
                ...
                <?php foreach ($languages as $language) { ?>
                    <div class="tab-pane" id="tab-language<?php echo $language['language_id']; ?>">
                        <table id="tab<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                            <thead>
                                    <tr>
                            ...
                            <?php $tab_row = 0; ?>
                            <?php foreach($tabs as $tab_data){ ?>
                            <?php foreach($tab_data as $lang_id=>$tab){ ?>
                            <?php if($lang_id == $language['language_id']) { ?>     
                                  <tbody id="tab-row<?php echo $tab_row; ?>">

                                    <tr id="attribute-row<?php echo $attribute_row; ?>">
                                      <td class="text-left"><input type="text" name="tab_data[<?php echo $tab_row; ?>][<?php echo $language['language_id']; ?>][name]" size="15" value="<?php echo isset($tab) ? $tab['name'] : ''; ?>" />
                                    <input type="hidden" name="tab_data[<?php echo $tab_row; ?>][<?php echo $language['language_id']; ?>][tab_row]" value="<?php echo $tab_row; ?>" />

                                    <?php if (isset($error_tabs[$tab_row])) if (isset($error_tabs[$tab_row][$language['language_id']])) { ?>

                                    <div class="text-danger"><?php echo $error_tabs[$tab_row][$language['language_id']]; ?></div>
                                    <?php } ?>

                                     </td>
                                      <td class="text-left"><input type="text" name="tab_data[<?php echo $tab_row; ?>][<?php echo $language['language_id']; ?>][sort_order]" size="1" value="<?php echo isset($tab) ? $tab['sort_order'] : ''; ?>" />
                                </td>
                                    <td class="text-left"><textarea name="tab_data[<?php echo $tab_row; ?>][<?php echo $language['language_id']; ?>][content]" id="tab_<?php echo $tab_row; ?>_<?php echo $language['language_id']; ?>"><?php echo isset($tab) ? $tab['content'] : ''; ?></textarea>
                                </td>
                                      <td class="text-left"><button type="button" onclick="$('#tab-row<?php echo $tab_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $text_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                                    </tr>
                            ...
                            <?php  } ?>
                                  <tfoot>
                                    <tr>
                                      <td colspan="3"></td>
                                      <td class="text-left"><button type="button" onclick="add_tab(<?php echo $language['language_id']; ?>);" data-toggle="tooltip" title="<?php echo $text_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                                    </tr>
                                  </tfoot>
                                </table>   
                                </div>
...
//--></script> 
                ...
                <?php foreach($tabs as $tab_data){ ?>
                    <?php foreach($tab_data as $lang_id=>$tab){ ?>  
                        $('#tab_<?php echo $tab_row; ?>_<?php echo $lang_id; ?>').summernote({height: 300});
                        <?php $tab_row++;?>
                    <?php  } ?>
                <?php } ?>   
                //END EXTRA PRODUCT TABS 
...
var attribute_row = <?php echo $attribute_row; ?>;
                    ...
                    //START EXTRA PRODUCT TABS
                    function add_tab(language_id) {
                        html  = '<tbody id="tab-row' + tab_row + '">';
                        html += '  <tr>';
                        html += '    <td class="left"><input size="15" type="text" name="tab_data[' + tab_row + ']['+language_id+'][name]" value="" /><input type="hidden" name="tab_data[' + tab_row + ']['+language_id+'][tab_row]" value="' + tab_row + '" /></td>';
                        html += '    <td class="left"><input type="text" name="tab_data[' + tab_row + ']['+language_id+'][sort_order]" size="1" value="" /></td>';
                        html += '    <td class="left">';
                        html += '<textarea name="tab_data['+tab_row+']['+language_id+'][content]" id="tab_'+tab_row+'_'+language_id+'"></textarea><br />';
                        html += '    </td>';
                        //html += '    <td class="left"><a onclick="$(\'#tab-row' + tab_row + '\').remove();" class="button"><?php echo $text_remove; ?></a></td>';
                        html += '  <td class="text-left"><button type="button" onclick="$(\'#tab-row' + tab_row + '\').remove();" data-toggle="tooltip" title="<?php echo $text_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
                        html += '  </tr>';	
                        html += '</tbody>';

                        $('#tab'+language_id+ ' tfoot').before(html);
                        $('#tab_'+tab_row+'_'+language_id).summernote({height: 100});
